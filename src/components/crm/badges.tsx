...
import { STAGE_LABELS, STAGE_COLORS, IMPORTANCE_LABELS, IMPORTANCE_COLORS, FOLLOW_UP_STATUS_LABELS, FOLLOW_UP_STATUS_COLORS, RELATION_TYPE_LABELS, RELATION_TYPE_COLORS, ASSIGNMENT_STATUS_LABELS, ASSIGNMENT_STATUS_COLORS } from "@/lib/crm/constants";
...
export function AssignmentStatusBadge({ status }: { status: string }) {
  return (
    <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${ASSIGNMENT_STATUS_COLORS[status] || "bg-gray-100 text-gray-600"}`}>
